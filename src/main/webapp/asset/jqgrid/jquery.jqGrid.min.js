...
(function (b) {
    b.jgrid = b.jgrid || {};
    b.extend(b.jgrid, {
        version: "4.4.3", htmlDecode: function (b) {
            ...
            return new function (e, c) {
                ...
                this._getGroup = function (a, c, e, f, i) {
                    ...
                    b.each(d._getOrder(a, c, e, f, i), function (a,
                                                                 e) {
                ...
                if ("TABLE" != this.tagName.toUpperCase())alert("Element is not a table"); else if (void 0 !== document.documentMode && 5 >= document.documentMode)alert("Grid can not be used in this ('quirks') mode!"); else {
                    ...
                    if (this.p.colNames.length !== this.p.colModel.length)alert(b.jgrid.errors.model); else {
                        ...
                        this.p.multiselect && (this.p.colNames.unshift("<input role='checkbox' id='cb_" + this.p.id + "' class='cbox' type='checkbox'/>"), this.p.colModel.unshift({
                            ...
                            a.p.multiselectWidth + a.p.cellLayout : a.p.multiselectWidth,
                            sortable: !1,
                            resizable: !1,
                            hidedlg: !0,
                            search: !1,
                        ...
                        b(c.bDiv).append(b('<div style="position:relative;' + (m && 8 > b.browser.version ? "height:0.01%;" : "") + '"></div>').append("<div></div>").append(this)).addClass("ui-jqgrid-bdiv").css({
                            height: a.p.height +
                            (isNaN(a.p.height) ? "" : "px"),
                            width: c.width + "px"
                        }).scroll(c.scrollGrid);
                        ...
                        a.updatepager = function (c, d) {
                            ...
                            if (a.p.scroll) {
                                ...
                                if (f = e.outerHeight() || a.grid.prevRowHeight) {
                                    ...
                                    b(">div:first", a.grid.bDiv).css({height: f}).children("div:first").css({
                                        height: e,
                                        display: e ? "" : "none"
                                    })
                                }
    ...
    b.jgrid.extend({
        getGridParam: function (b) {
            ...
            return this.each(function () {
                ...
                a.className && (this.p.selrow != a.id ? (b(this.rows.namedItem(this.p.selrow)).removeClass("ui-state-highlight").attr({
                    "aria-selected": "false",
                    tabindex: "-1"
                }), b(a).addClass("ui-state-highlight").attr({
                    "aria-selected": "true",
                    tabindex: "0"
                }), j && (b("#" + b.jgrid.jqID(this.p.selrow), "#" + b.jgrid.jqID(j)).removeClass("ui-state-highlight"), b("#" + b.jgrid.jqID(f), "#" + b.jgrid.jqID(j)).addClass("ui-state-highlight")), d = !0) : d = !1, this.p.selrow = a.id, b(this).triggerHandler("jqGridSelectRow", [a.id, d, c]), this.p.onSelectRow &&
                    ...
                    if (m && 0 < m) {
                        for (; n < m;) {
                            if (b(this.rows[n]).hasClass("jqgrow")) {
                                ...
                                c ?
                                    (j = parseFloat(a), i += j, void 0 === g && (g = h = j), h = Math.min(h, j), g = Math.max(g, j)) : e ? d.push({
                                    id: this.rows[n].id,
                                    value: a
                                }) : d.push(a)
                            }
            ...
            var e = b.extend({
                onEnter: null, onSpace: null,
                onLeftKey: null, onRightKey: null, scrollingRows: !0
            }, f || {});
            return this.each(function () {
                var c = this;
...
(function (a) {
    ...
    a.fmatter.util = {
        NumberFormat: function (c, b) {
            ...
            var l = i.getSeconds(), r = i.getMilliseconds(), n = i.getDay(), m = i.getFullYear(), o = (n + 6) % 7 + 1, p = (new Date(m, h - 1, g) - new Date(m, 0, 1)) / 864E5, q = {
                d: f(g),
                D: k.i18n.dayNames[n],
                j: g,
        ...
        setGridState: function (b) {
            ...
            return this.each(function () {
                ...
                if (!this.ftoolbar) {
                    var d = function () {
                        ...
                        q || a(c).jqGrid("setGridParam", {search: g}).trigger("reloadGrid", [{page: 1}]);
                    ...
                    this.clearToolbar = function (e) {
                        ...
                        n || e && a(c).jqGrid("setGridParam", {search: g}).trigger("reloadGrid", [{page: 1}]);
            ...
            return this.each(function () {
                ...
                for (c = 0; c < k; c++)if (j = p[c].el, m = a(j), d = l[c], e = {
                    ...
                    }, a("<th>", {role: "gridcell"}).css(e).addClass("ui-first-th-" + this.p.direction).appendTo(o), j.style.width =
                        "", e = r(d.name, b.groupHeaders), 0 <= e) {
                    e = b.groupHeaders[e];
                    g = e.numberOfColumns;
                    h = e.titleText;
                    for (e = d = 0; e < g && c + e < k; e++)l[c + e].hidden || d++;
                    e = a("<th>").attr({role: "columnheader"}).addClass("ui-state-default ui-th-column-header ui-th-" + this.p.direction).css({
                        height: "22px",
                        "border-top": "0px none"
                    }).html(h);
        ...
        searchGrid: function (b) {
            ...
            return this.each(function () {
                function d(c) {
                    ...
                    r && (a.jgrid.viewModal("#" + a.jgrid.jqID(q.themodal), {
            ...
            return this.each(function () {
                    ...
                    a(e.p.colModel).each(function (p) {
                        ...
                        if ("cb" !== l && "subgrid" !== l && !0 === this.editable && "rn" !== l) {
                            if (!1 === o)i = ""; else if (l == e.p.ExpandColumn && !0 === e.p.treeGrid)i = a("td[role='gridcell']:eq(" + p + ")", e.rows[o]).text(); else {
                                try {
                                    i = a.unformat.call(e, a("td[role='gridcell']:eq(" + p + ")", e.rows[o]), {
                                        rowId: d,
                                        colModel: this
                                    }, p)
                                } catch (r) {
                            ...
                            var s =
                                ...
                                rowabove: !1,
                                rowcontent: ""
                            }, this.formoptions || {}), x = parseInt(q.rowpos, 10) || t + 1, z = parseInt(2 * (parseInt(q.colpos, 10) || 1), 10);
                ...
                function s() {
                    ...
                    if (f[0] && !b[c.p.id].processing) {
                        ...
                        n = a.extend({
                            url: b[c.p.id].url || a(c).jqGrid("getGridParam", "editurl"),
                            type: b[c.p.id].mtype,
                            data: a.isFunction(b[c.p.id].serializeEditData) ? b[c.p.id].serializeEditData.call(c, j) : j,
                                ...
                                if (f[0] === false) {
                                    ...
                                    if (j[u] == t.addoper) {
                                        ...
                                        if (b[c.p.id].closeAfterAdd) {
                                            ...
                                            a.jgrid.hideModal("#" + a.jgrid.jqID(l.themodal), {
                                                gb: "#gbox_" + a.jgrid.jqID(p),
                                                jqm: d.jqModal,
                                                onClose: b[c.p.id].onClose
                                            })
                                        ...
                                        b[c.p.id].closeAfterEdit && a.jgrid.hideModal("#" + a.jgrid.jqID(l.themodal), {
                                            gb: "#gbox_" + a.jgrid.jqID(p),
                                            jqm: d.jqModal,
                                            onClose: b[c.p.id].onClose
                                        })
                        ...
                        h && (h = [!0, ""]), !1 === h[0] ? (f[0] = !1, f[1] = h[1] || "Error deleting the selected row!") : (n.data.oper == t.addoper && b[c.p.id].closeAfterAdd && a.jgrid.hideModal("#" + a.jgrid.jqID(l.themodal), {
                            gb: "#gbox_" + a.jgrid.jqID(p),
                            jqm: d.jqModal,
                            onClose: b[c.p.id].onClose
                        }), n.data.oper == t.editoper && b[c.p.id].closeAfterEdit && a.jgrid.hideModal("#" + a.jgrid.jqID(l.themodal), {
                            gb: "#gbox_" + a.jgrid.jqID(p),
                            jqm: d.jqModal,
                            onClose: b[c.p.id].onClose
                        }))) : a.ajax(n))
                ...
                var c = this;
                if (c.grid && v) {
                    var p = c.p.id, g = "FrmGrid_" + p, n = "TblGrid_" + p, k = "#" + a.jgrid.jqID(n), l = {
                        themodal: "editmod" + p,
                        modalhead: "edithd" + p,
                        modalcontent: "editcnt" + p,
                        scrollelm: g
                    }, x = a.isFunction(b[c.p.id].beforeShowForm) ? b[c.p.id].beforeShowForm : !1, z = a.isFunction(b[c.p.id].afterShowForm) ? b[c.p.id].afterShowForm : !1, y = a.isFunction(b[c.p.id].beforeInitData) ? b[c.p.id].beforeInitData : !1, t = a.isFunction(b[c.p.id].onInitializeForm) ?
                    ...
                    if (void 0 !== a("#" + a.jgrid.jqID(l.themodal))[0]) {
                        ...
                        a.jgrid.viewModal("#" + a.jgrid.jqID(l.themodal), {
                        ...
                        a("#" + a.jgrid.jqID(l.themodal)).keydown(function (e) {
                            ...
                            if (e.which === 27) {
                                if (!f())return false;
                                N && a.jgrid.hideModal("#" + a.jgrid.jqID(l.themodal), {
                                    gb: d.gbox,
                                    jqm: d.jqModal,
                                    onClose: b[c.p.id].onClose
                                });
            ...
            return this.each(function () {
                    ...
                    a(c.p.colModel).each(function (b) {
                        ...
                        if ("cb" !== j && "subgrid" !== j && "rn" !== j && w) {
                            ...
                            var d = a.extend({}, {
                                rowabove: !1,
                                rowcontent: ""
                            }, this.formoptions || {}), t = parseInt(d.rowpos, 10) || l + 1, o = parseInt(2 * (parseInt(d.colpos, 10) || 1), 10);
                            if (d.rowabove) {
                ...
                var m = this;
                if (m.grid && v) {
                    var f = m.p.id, h = "ViewGrid_" + a.jgrid.jqID(f), o = "ViewTbl_" + a.jgrid.jqID(f), w = "ViewGrid_" + f, c = "ViewTbl_" + f, p = {
                        themodal: "viewmod" + f,
                        modalhead: "viewhd" + f,
                        modalcontent: "viewcnt" + f,
                        scrollelm: h
                    }, g = a.isFunction(b[m.p.id].beforeInitData) ? b[m.p.id].beforeInitData : !1, n = !0, k = 1, l = 0;
            ...
            return this.each(function () {
                ...
                if (e.grid && v) {
                    var i = a.isFunction(b[e.p.id].beforeShowForm), r = a.isFunction(b[e.p.id].afterShowForm), q = a.isFunction(b[e.p.id].beforeInitData) ? b[e.p.id].beforeInitData : !1, s = e.p.id, m = {},
                        f = !0, h = "DelTbl_" + a.jgrid.jqID(s), o, w, c, p, g = "DelTbl_" + s, n = {
                            themodal: "delmod" + s,
                            modalhead: "delhd" + s,
                            ...
                            if (f[0] && !b[e.p.id].processing) {
                                ...
                                g = a.extend({
                                    ...
                                    data: a.isFunction(b[e.p.id].serializeDelData) ?
                                        b[e.p.id].serializeDelData.call(e, o) : o,
                                    complete: function (c, g) {
                                        ...
                                        f[0] && a.jgrid.hideModal("#" + a.jgrid.jqID(n.themodal), {
                                ...
                                if (f[0])if (b[e.p.id].useDataProxy) {
                                    ...
                                    } else a.jgrid.hideModal("#" + a.jgrid.jqID(n.themodal), {
                                        gb: "#gbox_" + a.jgrid.jqID(s),
                                        jqm: d.jqModal,
                                        onClose: b[e.p.id].onClose
                                    })
                ...
                if (!this.nav) {
                    ...
                    if (f.grid && "string" === typeof b) {
                        void 0 === a("#" + m.themodal)[0] && (!d.alerttop && !d.alertleft && (void 0 !== window.innerWidth ? (d.alertleft = window.innerWidth, d.alerttop = window.innerHeight) : void 0 !== document.documentElement && void 0 !== document.documentElement.clientWidth && 0 !== document.documentElement.clientWidth ? (d.alertleft = document.documentElement.clientWidth,
                            d.alerttop = document.documentElement.clientHeight) : (d.alertleft = 1024, d.alerttop = 768), d.alertleft = d.alertleft / 2 - parseInt(d.alertwidth, 10) / 2, d.alerttop = d.alerttop / 2 - 25), a.jgrid.createModal(m, "<div>" + d.alerttext + "</div><span tabindex='0'><span tabindex='-1' id='jqg_alrt'></span></span>", {
                        ...
                        for (w = 0; w < o; w++) {
                            ...
                            d.add && (i = i || {}, h = a("<td class='ui-pg-button ui-corner-all'></td>"), a(h).append("<div class='ui-pg-div'><span class='ui-icon " + d.addicon + "'></span>" + d.addtext + "</div>"), a("tr", g).append(h), a(h, g).attr({
                                title: d.addtitle || "",
                                id: i.id || "add_" + k
                            }).click(function () {
                            ...
                            d.edit && (h = a("<td class='ui-pg-button ui-corner-all'></td>"),
                                e = e || {}, a(h).append("<div class='ui-pg-div'><span class='ui-icon " + d.editicon + "'></span>" + d.edittext + "</div>"), a("tr", g).append(h), a(h, g).attr({
                                title: d.edittitle || "",
                                id: e.id || "edit_" + k
                            }).click(function () {
                            ...
                            d.view && (h = a("<td class='ui-pg-button ui-corner-all'></td>"),
                                s = s || {}, a(h).append("<div class='ui-pg-div'><span class='ui-icon " + d.viewicon + "'></span>" + d.viewtext + "</div>"), a("tr", g).append(h), a(h, g).attr({
                                title: d.viewtitle || "",
                                id: s.id || "view_" + k
                            }).click(function () {
                                if (!a(this).hasClass("ui-state-disabled")) {
                            ...
                            d.del && (h = a("<td class='ui-pg-button ui-corner-all'></td>"),
                                r = r || {}, a(h).append("<div class='ui-pg-div'><span class='ui-icon " + d.delicon + "'></span>" + d.deltext + "</div>"), a("tr", g).append(h), a(h, g).attr({
                                title: d.deltitle || "",
                                id: r.id || "del_" + k
                            }).click(function () {
                                if (!a(this).hasClass("ui-state-disabled")) {
                            ...
                            d.search && (h = a("<td class='ui-pg-button ui-corner-all'></td>"), q = q || {}, a(h).append("<div class='ui-pg-div'><span class='ui-icon " + d.searchicon + "'></span>" + d.searchtext + "</div>"), a("tr", g).append(h), a(h, g).attr({
                                title: d.searchtitle || "",
                                id: q.id || "search_" + k
                            }).click(function () {
                            ...
                            d.refresh && (h = a("<td class='ui-pg-button ui-corner-all'></td>"), a(h).append("<div class='ui-pg-div'><span class='ui-icon " + d.refreshicon + "'></span>" + d.refreshtext + "</div>"), a("tr", g).append(h), a(h, g).attr({
                                ...
                                if (!a(this).hasClass("ui-state-disabled")) {
                                    ...
                                    switch (d.refreshstate) {
                                        case "firstpage":
                                            ...
                                            break;
                                        case "current":
                                            a(f).trigger("reloadGrid", [{current: true}])
                                    }
    ...
    a.jgrid.extend({
        editRow: function (b, c, e, o, l, g, n, i, f) {
            ...
            var f = a.extend(!0, {
                ...
                restoreAfterError: !0,
                mtype: "POST"
            }, a.jgrid.inlineEdit, f), j = !1, d = this[0], m, h = {}, w = {}, r = {}, t, s, q;
            if (!d.grid)return j;
                    ...
                    c.edit && a(e).jqGrid("navButtonAdd", b, {
                        ...
                        onClickButton: function () {
                            ...
                            b ? (a(e).jqGrid("editRow", b, c.editParams), a("#" + l + "_ilsave").removeClass("ui-state-disabled"), a("#" + l + "_ilcancel").removeClass("ui-state-disabled"),
                                a("#" + l + "_iladd").addClass("ui-state-disabled"), a("#" + l + "_iledit").addClass("ui-state-disabled")) : (a.jgrid.viewModal("#alertmod", {
                                gbox: "#gbox_" + l,
                                jqm: !0
                            }), a("#jqg_alrt").focus())
                        }
        ...
        setSubGrid: function () {
            return this.each(function () {
                ...
                this.p.colModel.unshift({
                    name: "subgrid",
                    width: b.browser.safari || b.browser.webkit ? this.p.subGridWidth + this.p.cellLayout : this.p.subGridWidth,
                    sortable: !1,
                    resizable: !1,
                    hidedlg: !0,
                    search: !1,
        ...
        groupingSetup: function () {
            ...
            this.each(function () {
                ...
                for (b = 0; b < j; b++)k = f.groupField[b], l = f.displayField[b],
                    i = e[k], l = null == l ? null : e[l], null == l && (l = i), void 0 !== i && (0 === a ? (f.groups.push({
                    idx: b,
                    dataIndex: k,
                    value: i,
                    displayValue: l,
