!function (a, b, c, d) {
    ...
    g.prototype.init = function (b) {
        this.tree = [], this.nodes = [], b.data && ("string" == typeof b.data && (b.data = a.parseJSON(b.data)), this.tree = a.extend(!0, [], b.data), delete b.data), this.options = a.extend({}, f, b), this.destroy(), this.subscribeEvents(), this.setInitialStates({nodes: this.tree}, 0), this.render()
        ...
        this.unsubscribeEvents(), this.$element.on("click", a.proxy(this.clickHandler, this)), "function" == typeof this.options.onNodeCollapsed && this.$element.on("nodeCollapsed", this.options.onNodeCollapsed), "function" == typeof this.options.onNodeExpanded && this.$element.on("nodeExpanded", this.options.onNodeExpanded), "function" == typeof this.options.onNodeSelected && this.$element.on("nodeSelected", this.options.onNodeSelected), "function" == typeof this.options.onNodeUnselected && this.$element.on("nodeUnselected", this.options.onNodeUnselected), "function" == typeof this.options.onSearchComplete && this.$element.on("searchComplete", this.options.onSearchComplete), "function" == typeof this.options.onSearchCleared && this.$element.on("searchCleared", this.options.onSearchCleared)
    }, g.prototype.setInitialStates = function (b, c) {
        if (b.nodes) {
            c += 1;
            var d = b, e = this;
            a.each(b.nodes, function (a, b) {
                b.nodeId = e.nodes.length, b.parentId = d.nodeId, b.hasOwnProperty("selectable") || (b.selectable = !0), b.state = b.state || {}, b.state.hasOwnProperty("expanded") || (b.state.expanded = c < e.options.levels ? !0 : !1), b.state.hasOwnProperty("selected") || (b.state.selected = !1), e.nodes.push(b), b.nodes && e.setInitialStates(b, c)
            })
        }
    }, g.prototype.clickHandler = function (b) {
        this.options.enableLinks || b.preventDefault();
        var c = a(b.target), d = c.attr("class") ? c.attr("class").split(" ") : [], e = this.findNode(c);
        -1 != d.indexOf("click-expand") || -1 != d.indexOf("click-collapse") ? this.toggleExpandedState(e) : e && (e.selectable ? this.toggleSelectedState(e) : this.toggleExpandedState(e))
        ...
        a && (this.setExpandedState(a, !a.state.expanded, b), this.render())
    }, g.prototype.setExpandedState = function (b, c, d) {
        c ? (b.state.expanded = !0, d || this.$element.trigger("nodeExpanded", a.extend(!0, {}, b))) : (b.state.expanded = !1, d || this.$element.trigger("nodeCollapsed", a.extend(!0, {}, b)))
    }, g.prototype.toggleSelectedState = function (a, b) {
        a && (this.setSelectedState(a, !a.state.selected, b), this.render())
    }, g.prototype.setSelectedState = function (b, c, d) {
        c ? (this.options.multiSelect || a.each(this.findNodes("true", "g", "state.selected"), a.proxy(function (a, b) {
            this.setSelectedState(b, !1, d)
        }, this)), b.state.selected = !0, d || this.$element.trigger("nodeSelected", a.extend(!0, {}, b))) : (b.state.selected = !1, d || this.$element.trigger("nodeUnselected", a.extend(!0, {}, b)))
        ...
        return this.options.color && (a += "color:" + this.options.color + ";"), this.options.backColor && (a += "background-color:" + this.options.backColor + ";"), this.options.showBorder ? this.options.borderColor && (a += "border:1px solid " + this.options.borderColor + ";") : a += "border:none;", a += "}", this.options.onhoverColor && (a += ".node-" + this.elementId + ":hover{background-color:" + this.options.onhoverColor + ";}"), this.css + a
    ...
    }, g.prototype.css = ".treeview .list-group-item{cursor:pointer}.treeview span.indent{margin-left:10px;margin-right:10px}.treeview span.expand-collapse{width:1rem;height:1rem}.treeview span.icon{margin-left:10px;margin-right:5px}", g.prototype.getNode = function (a) {
        return this.nodes[a]
    ...
    }, g.prototype.selectNode = function (a, b) {
        var c = this.isSilent(b);
        this.setSelectedState(this.identifyNode(a), !0, c), this.render()
    }, g.prototype.unselectNode = function (a, b) {
        var c = this.isSilent(b);
        this.setSelectedState(this.identifyNode(a), !1, c), this.render()
    }, g.prototype.toggleNodeSelected = function (a, b) {
        this.toggleSelectedState(this.identifyNode(a), this.isSilent(b))
    }, g.prototype.collapseAll = function (b) {
        var c = this.isSilent(b);
        a.each(this.nodes, a.proxy(function (a, b) {
            this.setExpandedState(b, !1, c)
        }, this)), this.render()
    }, g.prototype.collapseNode = function (a, b) {
        var c = this.isSilent(b);
        this.setExpandedState(this.identifyNode(a), !1, c), this.render()
    }, g.prototype.expandAll = function (b) {
        var c = this.isSilent(b);
        b && b.levels ? this.expandLevels(this.tree, b.levels, c) : a.each(this.nodes, a.proxy(function (a, b) {
            this.setExpandedState(b, !0, c)
        }, this)), this.render()
    }, g.prototype.expandNode = function (a, b) {
        var c = this.isSilent(b), d = this.identifyNode(a);
        this.setExpandedState(d, !0, c), d.nodes && b && b.levels && this.expandLevels(d.nodes, b.levels - 1, c), this.render()
    }, g.prototype.expandLevels = function (b, c, d) {
        a.each(b, a.proxy(function (a, b) {
            this.setExpandedState(b, c > 0 ? !0 : !1), b.nodes && this.expandLevels(b.nodes, c - 1, d)
        }, this))
    }, g.prototype.toggleNodeExpanded = function (a, b) {
        this.toggleExpandedState(this.identifyNode(a), this.isSilent(b))
    }, g.prototype.identifyNode = function (a) {
        return "number" == typeof a ? this.nodes[a] : a
    }, g.prototype.isSilent = function (a) {
        return a && a.hasOwnProperty("silent") ? a.silent : !1
        ...
        return this.$element.trigger("searchComplete", a.extend(!0, {}, d)), d
    }, g.prototype.clearSearch = function () {
        var b = a.each(this.findNodes("true", "g", "searchResult"), function (a, b) {
            b.searchResult = !1
        });
        this.render(), this.$element.trigger("searchCleared", a.extend(!0, {}, b))
