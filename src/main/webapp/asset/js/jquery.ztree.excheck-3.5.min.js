...
(function (m) {
    var p, q, r, o = {
        ...
        callback: {beforeCheck: null, onCheck: null}
    };
    p = function (c,
                  a) {
    ...
    m.extend(!0, m.fn.zTree._z, {
        tools: {}, view: {
            checkNodeRelation: function (c, a) {
                ...
                if (a.parentTId) {
                    l = !0;
                    if (!b)for (var h = a.getParentNode()[h], f = 0, k = h.length; f < k; f++)if (h[f].nocheck !== !0 && h[f].chkDisabled !== !0 && h[f][i] || (h[f].nocheck === !0 || h[f].chkDisabled === !0) && h[f].check_Child_State > 0) {
                        l = !1;
                        break
                    }
            ...
            getRadioCheckedList: function (c) {
                ...
                if (!a)return [];
                for (var d = c.data.key.children, h = c.data.key.checked, b = !b ? [] : b, i = 0, e = a.length; i < e; i++)a[i].nocheck !== !0 && a[i].chkDisabled !== !0 && a[i][h] != a[i].checkedOld && b.push(a[i]), g.getTreeChangeCheckedNodes(c, a[i][d], b);
                return b
