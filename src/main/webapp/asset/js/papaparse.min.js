...
!(function (e) {
    ...
    function u(t, n) {
        ...
        var i = null;
        if (typeof t === "string") {
            if (n.download)i = new l(n); else i = new h(n)
    ...
    function a(t, n) {
        ...
        if (t instanceof Array) {
            if (!t.length || t[0]instanceof Array)return l(null, t); else if (typeof t[0] === "object")return l(f(t[0]), t)
    ...
    function f(n) {
        ...
        this._sendError = function (n) {
            if (x(this._config.error))this._config.error(n); else if (t && this._config.error) {
                e.postMessage({
                    workerId: Papa.WORKER_ID,
                    error: n,
                    finished: false
    ...
    function l(e) {
        ...
        this._readChunk = function () {
            ...
            if (t && n.status == 0)this._chunkError(); else this._start += this._config.chunkSize
        };
    ...
    function p(e) {
        ...
        function v() {
            ...
            for (var t = 0; t < f.data.length; t++) {
                ...
                for (var r = 0; r < f.data[t].length; r++) {
                    if (e.dynamicTyping) {
                        var i = f.data[t][r];
                        if (i == "true")f.data[t][r] = true; else if (i == "false")f.data[t][r] = false; else f.data[t][r] = y(i)
                    }
                    if (e.header) {
                        if (r >= a.length) {
                ...
                if (e.header) {
                    f.data[t] = n;
                    if (r > a.length)b("FieldMismatch", "TooManyFields", "Too many fields: expected " + a.length + " fields but parsed " + r, t); else if (r < a.length)b("FieldMismatch", "TooFewFields", "Too few fields: expected " + a.length + " fields but parsed " + r, t)
                }
            }
        ...
        this.parse = function (t, n, r) {
            ...
            if (!e.delimiter) {
                var a = m(t);
                if (a.successful)e.delimiter = a.bestDelimiter; else {
                    u = true;
    ...
    function d(e) {
        ...
        this.parse = function (e, f, l) {
            ...
            var c = e.length, h = t.length, p = n.length, d = r.length;
            ...
            if (o || o !== false && e.indexOf('"') === -1) {
                ...
                for (var E = 0; E < w.length; E++) {
                    var y = w[E];
                    u += y.length;
                    if (E !== w.length - 1)u += n.length; else if (l)return A();
