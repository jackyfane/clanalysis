...
(function (d) {
    ...
    d.SVGRenderer.prototype.cuboid = function (c) {
        ...
        a.front = this.path(c[0]).attr({
            zIndex: c[3],
            "stroke-linejoin": "round"
        }).add(a);
        a.top = this.path(c[1]).attr({
            zIndex: c[4],
            "stroke-linejoin": "round"
        }).add(a);
        a.side = this.path(c[2]).attr({
            zIndex: c[5],
            "stroke-linejoin": "round"
        }).add(a);
    ...
    d.wrap(d.Axis.prototype, "getPlotLinePath", function (c) {
        ...
        var b = this.chart.options.chart.options3d, b = this.isZAxis ? this.chart.plotWidth : b.depth,
            d = this.opposite;
        this.horiz && (d = !d);
        a = [this.swapZ({x: a[1], y: a[2], z: d ? b : 0}), this.swapZ({
            x: a[1],
            y: a[2],
            z: b
        }), this.swapZ({x: a[4], y: a[5], z: b}), this.swapZ({
            x: a[4],
            y: a[5],
            z: d ? 0 : b
        })];
    ...
    d.wrap(d.Tick.prototype, "getMarkPath", function (c) {
        ...
        a = [this.axis.swapZ({
            ...
            y: a[2],
            z: 0
        }), this.axis.swapZ({x: a[4], y: a[5], z: 0})];
    ...
    d.wrap(d.Axis.prototype, "getTitlePosition", function (c) {
        var a = c.apply(this, [].slice.call(arguments, 1));
        return !this.chart.is3d() ? a : a = n([this.swapZ({
            x: a.x,
            y: a.y,
            z: 0
        })], this.chart, !1)[0]
    ...
    d.Axis.prototype.swapZ = function (c, a) {
        if (this.isZAxis) {
            ...
            return {
                x: b + (d.yAxis[0].opposite ? c.z : d.xAxis[0].width - c.z),
                y: c.y,
                z: c.x - b
            }
        } else return c
