...
<script type="text/javascript"
        src="${pageContext.request.contextPath}/Scripts/js/reportContainer.class.js"></script>
<script type="text/javascript"
        src="${pageContext.request.contextPath}/Scripts/js/reportElement.class.js"></script>


<script type="text/javascript"
        src="${pageContext.request.contextPath}/Scripts/js/tinycolor.js"></script>
<script type="text/javascript"
        src="${pageContext.request.contextPath}/Scripts/js/pick-a-color-1.2.3.min.js"></script>
<link rel="stylesheet"
      href="${pageContext.request.contextPath}/Scripts/js/pick-a-color-1.2.3.min.css">
            ...
            <div class="tab-content">
                <div role="tabpanel" class="tab-pane active" id="chartC">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-5">
                            <div class="Y-Pointer" id='Y-Pointer'></div>
                        </div>
                        <div class="col-md-1">
                            <button type="button" class="btn btn-xs btn-info"
                                    id="chartAddY">载入指标</span>
                            </button>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6">
                            <input name="yAxis-s" type="text" class="form-control input-sm" id="chartYAxis-s"/>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="col-md-5 text-right  checkbox">
                        ...
                        <div class="col-md-6">
                            <textarea class="form-control"  id="chartFoot"></textarea>
                        </div>
                    </div>
                    -->
                    <!--图表结束-->
                ...
                <div role="tabpanel" class="tab-pane" id="textC">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6">
                            <select name="" class="form-control input-sm"
                                    id="textReport">
                                <option value="1">网站月报概览</option>
                                <option value="2">网站月报概览2</option>
                            </select>
                        </div>
                    </div>
                    <div class="form-group">
