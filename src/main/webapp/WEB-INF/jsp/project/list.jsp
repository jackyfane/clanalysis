...
<div class="panel panel-default">
    ...
    <div class="panel-body">
        <jsp:include page="../item-search-form.jsp"/>
...
//                html += '\t<td>'+this.description+'</td>\n';
                ...
                html += '\t\t<a href="#" onclick="report(\'' + this.id + '\');"><span class="fa fa-file-pdf-o"></span>报告</a> |\n';
    ...
    function report(pid) {
        location.href = 'detail?id=' + pid + '&target=report';
    }
</script>
